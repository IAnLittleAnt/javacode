...
public class ImageRemarkUtil {
    ...
    public static void main(String[] args) {
        ...
        BufferedImage imgBuffIcon = null;
		try {
			imgBuff = ImageIO.read(new File(srcImgPath));
			imgBuffIcon = ImageIO.read(new File(iconPath));
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
		Integer width = imgBuff.getWidth()/2-imgBuffIcon.getWidth()/2;
		Integer height = imgBuff.getHeight()/2-imgBuffIcon.getHeight()/2;
        
        System.out.println("给图片添加水印图片开始...");
        setImageMarkOptions(0.7f, width, height, null, null);
        // 给图片添加水印图片
