...
<body>
			...
			<div class="layui-col-md12">
				<div class="layui-card">
					...
					<div class="layui-card-body">
						...
						<blockquote class="layui-elem-quote" style="display: none;">注：常量值列为单元格编辑列，点击可直接修改。</blockquote>
					</div>
				</div>
			</div>
		</div>
    ...
    <script src="<%=ligent_unitPath%>adonis/ligent/const/list.js?v=<%=System.currentTimeMillis() %>"></script>
