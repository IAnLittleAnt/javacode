...
<body>
			...
			<div class="layui-col-md12">
				<div class="layui-card">
					<div class="layui-card-header">
						...
						<span class="childTitle">/&nbsp;编辑用户信息</span>
						...
						<div class="layui-form">
			              	<div class="layui-card-body layui-row layui-col-space10">
			              		<form class="layui-form from-scale" id="MyForm">
			              			<input id="constId" name="constId" value="${ligentConst.constId }" type="hidden">
									<div class="layui-form-item">
					              		<label class="layui-form-label"><span class="must">*</span>常量编码：</label>
					             		<div class="layui-input-block">
					                		<input name="constKey" value="${ligentConst.constKey }" type="text" lay-verify="required" placeholder="" autocomplete="off" class="layui-input layui-form-danger">
					              		</div>
					            	</div>
					            	<div class="layui-form-item">
					              		<label class="layui-form-label"><span class="must">*</span>常量名称：</label>
					             		<div class="layui-input-block">
					                		<input name="constName" value="${ligentConst.constName }" type="text" lay-verify="required" placeholder="" autocomplete="off" class="layui-input layui-form-danger">
					              		</div>
					            	</div>
					            	<div class="layui-form-item">
					              		<label class="layui-form-label"><span class="must">*</span>常量值：</label>
					             		<div class="layui-input-block">
					                		<input name="constValue" value="${ligentConst.constValue }" type="text" lay-verify="required" placeholder="" autocomplete="off" class="layui-input layui-form-danger">
					              		</div>
					            	</div>
					            	<div class="layui-form-item">
					              		<label class="layui-form-label">常量类型：</label>
					             		<div class="layui-input-block">
											<input name="valueType" type="radio" value="int" title="数字" lay-skin="primary" <c:if test="${ligentConst.valueType=='int' }">checked="checked"</c:if> >
											<input name="valueType" type="radio" value="varchar" title="字符串" lay-skin="primary" <c:if test="${ligentConst.valueType=='varchar' }">checked="checked"</c:if> >
					              		</div>
					            	</div>
					            	<div class="layui-form-item">
					              		<label class="layui-form-label">常量排序：</label>
					             		<div class="layui-input-block">
					             			<input name="constSort" value="${ligentConst.constSort }" type="text" lay-verify="required" placeholder="" autocomplete="off" class="layui-input layui-form-danger" onkeyup="this.value=this.value.replace(/[^0-9|{2}\.]/g,'')" >
					              		</div>
					            	</div>
					            	<div class="layui-form-item">
					              		<label class="layui-form-label">使用场景：</label>
					             		<div class="layui-input-block">
					                		<textarea name="used" placeholder="" class="layui-textarea">${ligentConst.used }</textarea>
					              		</div>
					            	</div>
						          	<div class="layui-form-item">
					              		<div class="layui-input-block">
    ...
    <script src="<%=ligent_unitPath%>adonis/ligent/const/edit.js?v=<%=System.currentTimeMillis() %>"></script>
